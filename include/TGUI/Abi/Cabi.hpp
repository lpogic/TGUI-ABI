...
namespace tgui
{
	...
	C_ABI_RAW int ABI_Color_get_red(Color* self);
	C_ABI_RAW int ABI_Color_get_green(Color* self);
	C_ABI_RAW int ABI_Color_get_blue(Color* self);
	C_ABI_RAW int ABI_Color_get_alpha(Color* self);
	C_ABI_RAW Color* ABI_Color_applyOpacity(Color* self, float fade);
	// Signal
	...
	// BackendGui
	C_ABI_RAW void ABI_BackendGui_setTextSize(BackendGui* self, int textSize);
	C_ABI_RAW int ABI_BackendGui_getTextSize(BackendGui* self);
	...
	C_ABI_RAW bool ABI_Gui_isActive(Gui* self);
	C_ABI_RAW void ABI_Gui_pollEvents(Gui* self);
	C_ABI_RAW void ABI_Gui_draw(Gui* self);
	C_ABI_RAW void ABI_Gui_add(Gui* self, Widget::Ptr* widget, const char* name);
	C_ABI_RAW void ABI_Gui_remove(Gui* self, Widget::Ptr* widget);
	C_ABI_RAW void ABI_Gui_removeAll(Gui* self);
	C_ABI_RAW void ABI_Gui_mainLoop(Gui* self);
	...
	C_ABI_RAW void ABI_EditBox_setReadOnly(EditBox::Ptr* self, int read_only);
	...
	C_ABI_RAW void ABI_Label_setAutoSize(Label::Ptr* self, int auto_size);
	C_ABI_RAW bool ABI_Label_getAutoSize(Label::Ptr* self);
	C_ABI_RAW void ABI_Label_setMaximumTextWidth(Label::Ptr* self, float maximumWidth);
	C_ABI_RAW float ABI_Label_getMaximumTextWidth(Label::Ptr* self);
	C_ABI_RAW void ABI_Label_ignoreMouseEvents(Label::Ptr* self, int ignore);
	C_ABI_RAW bool ABI_Label_ignoringMouseEvents(Label::Ptr* self);
	// RadioButton
	...
	C_ABI_RAW void ABI_Knob_setStartRotation(Knob::Ptr* self, float startRotation);
	C_ABI_RAW float ABI_Knob_getStartRotation(Knob::Ptr* self);
	C_ABI_RAW void ABI_Knob_setEndRotation(Knob::Ptr* self, float endRotation);
	C_ABI_RAW float ABI_Knob_getEndRotation(Knob::Ptr* self);
	C_ABI_RAW void ABI_Knob_setMinimum(Knob::Ptr* self, float minimum);
	C_ABI_RAW float ABI_Knob_getMinimum(Knob::Ptr* self);
	C_ABI_RAW void ABI_Knob_setMaximum(Knob::Ptr* self, float maximum);
	C_ABI_RAW float ABI_Knob_getMaximum(Knob::Ptr* self);
	C_ABI_RAW void ABI_Knob_setValue(Knob::Ptr* self, float value);
	C_ABI_RAW float ABI_Knob_getValue(Knob::Ptr* self);
	C_ABI_RAW void ABI_Knob_setClockwiseTurning(Knob::Ptr* self, int clockwiseTurning);
	C_ABI_RAW float ABI_Knob_getClockwiseTurning(Knob::Ptr* self);
	C_ABI_RAW SignalFloat* ABI_Knob_onValueChange(Knob::Ptr* self);
	//// ChatBox
 ...
 //   TGUI_NODISCARD unsigned int getScrollbarValue() const;
	...
	C_ABI_RAW bool ABI_Container_remove(Container::Ptr* self, Widget::Ptr* widget);
	C_ABI_RAW void ABI_Container_removeAllWidgets(Container::Ptr* self);
	C_ABI_RAW Vector2f* ABI_Container_getInnerSize(Container::Ptr* self);
	C_ABI_RAW Vector2f* ABI_Container_getChildWidgetsOffset(Container::Ptr* self);
	C_ABI_RAW void ABI_Container_moveWidgetToFront(Container::Ptr* self, Widget::Ptr* widget);
	C_ABI_RAW void ABI_Container_moveWidgetToBack(Container::Ptr* self, Widget::Ptr* widget);
	C_ABI_RAW int ABI_Container_moveWidgetForward(Container::Ptr* self, Widget::Ptr* widget);
	C_ABI_RAW int ABI_Container_moveWidgetBackward(Container::Ptr* self, Widget::Ptr* widget);
	C_ABI_RAW bool ABI_Container_setWidgetIndex(Container::Ptr* self, Widget::Ptr* widget, int index);
	C_ABI_RAW int ABI_Container_getWidgetIndex(Container::Ptr* self, Widget::Ptr* widget);
	C_ABI_RAW Widget::Ptr* ABI_Container_getFocusedChild(Container::Ptr* self);
	C_ABI_RAW Widget::Ptr* ABI_Container_getFocusedLeaf(Container::Ptr* self);
	C_ABI_RAW Widget::Ptr* ABI_Container_getWidgetAtPosition(Container::Ptr* self, float x, float y);
	C_ABI_RAW bool ABI_Container_focusNextWidget(Container::Ptr* self, int recursive);
	C_ABI_RAW bool ABI_Container_focusPreviousWidget(Container::Ptr* self, int recursive);
	// ChildWindow
	...
	C_ABI_RAW Vector2f* ABI_ChildWindow_getClientSize(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setMaximumSize(ChildWindow::Ptr* self, float x, float y);
	C_ABI_RAW Vector2f* ABI_ChildWindow_getMaximumSize(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setMinimumSize(ChildWindow::Ptr* self, float x, float y);
	C_ABI_RAW Vector2f* ABI_ChildWindow_getMinimumSize(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setTitle(ChildWindow::Ptr* self, char* title);
	C_ABI_RAW const char32_t* ABI_ChildWindow_getTitle(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setTitleTextSize(ChildWindow::Ptr* self, unsigned int size);
	C_ABI_RAW unsigned int ABI_ChildWindow_getTitleTextSize(ChildWindow::Ptr* self);
	...
	C_ABI_RAW void ABI_ChildWindow_close(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_destroy(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setResizable(ChildWindow::Ptr* self, int resizable);
	C_ABI_RAW bool ABI_ChildWindow_isResizable(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setPositionLocked(ChildWindow::Ptr* self, int positionLocked);
	C_ABI_RAW bool ABI_ChildWindow_isPositionLocked(ChildWindow::Ptr* self);
	C_ABI_RAW void ABI_ChildWindow_setKeepInParent(ChildWindow::Ptr* self, int enabled);
	C_ABI_RAW bool ABI_ChildWindow_isKeptInParent(ChildWindow::Ptr* self);
	C_ABI_RAW Signal* ABI_ChildWindow_onMousePress(ChildWindow::Ptr* self);
	C_ABI_RAW Signal* ABI_ChildWindow_onClose(ChildWindow::Ptr* self);
	C_ABI_RAW Signal* ABI_ChildWindow_onMinimize(ChildWindow::Ptr* self);
	C_ABI_RAW Signal* ABI_ChildWindow_onMaximize(ChildWindow::Ptr* self);
	C_ABI_RAW Signal* ABI_ChildWindow_onEscapeKeyPress(ChildWindow::Ptr* self);
	C_ABI_RAW SignalTyped<bool*>* ABI_ChildWindow_onClosing(ChildWindow::Ptr* self);
	// Group
	C_ABI_MAKE Group::Ptr* ABI_Group_new();
	// BoxLayout
	C_ABI_RAW Widget::Ptr* ABI_BoxLayout_getByIndex(BoxLayout::Ptr* self, int index);
	C_ABI_RAW void ABI_BoxLayout_insert(BoxLayout::Ptr* self, int index, Widget::Ptr* widget, char* name);
	C_ABI_RAW bool ABI_BoxLayout_removeByIndex(BoxLayout::Ptr* self, int index);
	// BoxLayoutRatios
	C_ABI_RAW void ABI_BoxLayoutRatios_addSpace(BoxLayoutRatios::Ptr* self, float ratio);
	C_ABI_RAW void ABI_BoxLayoutRatios_insertSpace(BoxLayoutRatios::Ptr* self, int index, float ratio);
	...
	C_ABI_RAW SignalVector2f* ABI_Panel_onMousePress(Panel::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Panel_onMouseRelease(Panel::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Panel_onClick(Panel::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Panel_onDoubleClick(Panel::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Panel_onRightMousePress(Panel::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Panel_onRightMouseRelease(Panel::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Panel_onRightClick(Panel::Ptr* self);
	// ScrollablePanel
	C_ABI_MAKE ScrollablePanel::Ptr* ABI_ScrollablePanel_create();
	C_ABI_RAW void ABI_ScrollablePanel_setContentSize(ScrollablePanel::Ptr* self, float x, float y);
	C_ABI_RAW Vector2f* ABI_ScrollablePanel_getContentSize(ScrollablePanel::Ptr* self);
	C_ABI_RAW Vector2f* ABI_ScrollablePanel_getContentOffset(ScrollablePanel::Ptr* self);
	C_ABI_RAW float ABI_ScrollablePanel_getScrollbarWidth(ScrollablePanel::Ptr* self);
	C_ABI_RAW void ABI_ScrollablePanel_setVerticalScrollbarPolicy(ScrollablePanel::Ptr* self, int policy);
	C_ABI_RAW int ABI_ScrollablePanel_getVerticalScrollbarPolicy(ScrollablePanel::Ptr* self);
	C_ABI_RAW void ABI_ScrollablePanel_setHorizontalScrollbarPolicy(ScrollablePanel::Ptr* self, int policy);
	C_ABI_RAW int ABI_ScrollablePanel_getHorizontalScrollbarPolicy(ScrollablePanel::Ptr* self);
	C_ABI_RAW void ABI_ScrollablePanel_setVerticalScrollAmount(ScrollablePanel::Ptr* self, int amount);
	C_ABI_RAW int ABI_ScrollablePanel_getVerticalScrollAmount(ScrollablePanel::Ptr* self);
	C_ABI_RAW void ABI_ScrollablePanel_setHorizontalScrollAmount(ScrollablePanel::Ptr* self, int amount);
	C_ABI_RAW int ABI_ScrollablePanel_getHorizontalScrollAmount(ScrollablePanel::Ptr* self);
	C_ABI_RAW void ABI_ScrollablePanel_setVerticalScrollbarValue(ScrollablePanel::Ptr* self, int value);
	C_ABI_RAW int ABI_ScrollablePanel_getVerticalScrollbarValue(ScrollablePanel::Ptr* self);
	C_ABI_RAW void ABI_ScrollablePanel_setHorizontalScrollbarValue(ScrollablePanel::Ptr* self, int value);
	C_ABI_RAW int ABI_ScrollablePanel_getHorizontalScrollbarValue(ScrollablePanel::Ptr* self);
	// Grid
	C_ABI_MAKE Grid::Ptr* ABI_Grid_make();
	C_ABI_RAW void ABI_Grid_setAutoSize(Grid::Ptr* self, int autoSize);
	C_ABI_RAW bool ABI_Grid_isAutoSize(Grid::Ptr* self);
	...
	C_ABI_RAW int ABI_ListBox_addItem(ListBox::Ptr* self, char* itemName, char* id);
	C_ABI_RAW bool ABI_ListBox_setSelectedItem(ListBox::Ptr* self, char* itemName);
	C_ABI_RAW bool ABI_ListBox_setSelectedItemById(ListBox::Ptr* self, char* id);
	C_ABI_RAW bool ABI_ListBox_setSelectedItemByIndex(ListBox::Ptr* self, int index);
	C_ABI_RAW void ABI_ListBox_deselectItem(ListBox::Ptr* self);
	C_ABI_RAW bool ABI_ListBox_removeItem(ListBox::Ptr* self, char* itemName);
	C_ABI_RAW bool ABI_ListBox_removeItemById(ListBox::Ptr* self, char* id);
	C_ABI_RAW bool ABI_ListBox_removeItemByIndex(ListBox::Ptr* self, int index);
	C_ABI_RAW void ABI_ListBox_removeAllItems(ListBox::Ptr* self);
	C_ABI_RAW const char32_t* ABI_ListBox_getItemById(ListBox::Ptr* self, char* id);
	C_ABI_RAW const char32_t* ABI_ListBox_getItemByIndex(ListBox::Ptr* self, int index);
	C_ABI_RAW int ABI_ListBox_getIndexById(ListBox::Ptr* self, char* id);
	C_ABI_RAW const char32_t* ABI_ListBox_getIdByIndex(ListBox::Ptr* self, int index);
	C_ABI_RAW const char32_t* ABI_ListBox_getSelectedItem(ListBox::Ptr* self);
	C_ABI_RAW const char32_t* ABI_ListBox_getSelectedItemId(ListBox::Ptr* self);
	C_ABI_RAW const int ABI_ListBox_getSelectedItemIndex(ListBox::Ptr* self);
	C_ABI_RAW bool ABI_ListBox_changeItem(ListBox::Ptr* self, char* originalValue, char* newValue);
	C_ABI_RAW bool ABI_ListBox_changeItemById(ListBox::Ptr* self, char* id, char* newValue);
	C_ABI_RAW bool ABI_ListBox_changeItemByIndex(ListBox::Ptr* self, int index, char* newValue);
	C_ABI_RAW int ABI_ListBox_getItemCount(ListBox::Ptr* self);
	...
	C_ABI_RAW void ABI_ListBox_setItemHeight(ListBox::Ptr* self, int itemHeight);
	C_ABI_RAW int ABI_ListBox_getItemHeight(ListBox::Ptr* self);
	C_ABI_RAW void ABI_ListBox_setMaximumItems(ListBox::Ptr* self, int maximumItems);
	C_ABI_RAW int ABI_ListBox_getMaximumItems(ListBox::Ptr* self);
	C_ABI_RAW void ABI_ListBox_setAutoScroll(ListBox::Ptr* self, int autoScroll);
	C_ABI_RAW bool ABI_ListBox_getAutoScroll(ListBox::Ptr* self);
	...
	C_ABI_RAW bool ABI_ListBox_contains(ListBox::Ptr* self, char* item);
	C_ABI_RAW bool ABI_ListBox_containsId(ListBox::Ptr* self, char* id);
	C_ABI_RAW void ABI_ListBox_setScrollbarValue(ListBox::Ptr* self, int value);
	C_ABI_RAW int ABI_ListBox_getScrollbarValue(ListBox::Ptr* self);
	C_ABI_RAW SignalItem* ABI_ListBox_onItemSelect(ListBox::Ptr* self);
	C_ABI_RAW SignalItem* ABI_ListBox_onMousePress(ListBox::Ptr* self);
	C_ABI_RAW SignalItem* ABI_ListBox_onMouseRelease(ListBox::Ptr* self);
	C_ABI_RAW SignalItem* ABI_ListBox_onDoubleClick(ListBox::Ptr* self);
	C_ABI_RAW Signal* ABI_ListBox_onScroll(ListBox::Ptr* self);
	// ListView
	C_ABI_MAKE ListView::Ptr* ABI_ListView_make();
	C_ABI_RAW int ABI_ListView_addColumn(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setColumnText(ListView::Ptr* self, int index, char* text);
	C_ABI_RAW const char32_t* ABI_ListView_getColumnText(ListView::Ptr* self, int index);
	C_ABI_RAW void ABI_ListView_setColumnWidth(ListView::Ptr* self, int index, float width);
	C_ABI_RAW float ABI_ListView_getColumnWidth(ListView::Ptr* self, int index);
	...
	C_ABI_RAW void ABI_ListView_removeAllColumns(ListView::Ptr* self);
	C_ABI_RAW int ABI_ListView_getColumnCount(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setHeaderHeight(ListView::Ptr* self, float height);
	C_ABI_RAW float ABI_ListView_getHeaderHeight(ListView::Ptr* self);
	C_ABI_RAW float ABI_ListView_getCurrentHeaderHeight(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setHeaderVisible(ListView::Ptr* self, int showHeader);
	C_ABI_RAW bool ABI_ListView_headerVisible(ListView::Ptr* self);
	...
	C_ABI_RAW void ABI_ListView_removeAllItems(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setSelectedItem(ListView::Ptr* self, int index);
	C_ABI_RAW void ABI_ListView_setSelectedItems(ListView::Ptr* self, int(*f)(void));
	C_ABI_RAW void ABI_ListView_deselectItems(ListView::Ptr* self);
	C_ABI_RAW int ABI_ListView_getSelectedItemIndex(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_getSelectedItemIndices(ListView::Ptr* self, void(*f)(int));
	C_ABI_RAW void ABI_ListView_setMultiSelect(ListView::Ptr* self, int multiSelect);
	C_ABI_RAW bool ABI_ListView_multiSelect(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setItemIcon(ListView::Ptr* self, int index, Texture* texture);
	C_ABI_RAW Texture* ABI_ListView_getItemIcon(ListView::Ptr* self, int index);
	C_ABI_RAW int ABI_ListView_getItemCount(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_getItemRow(ListView::Ptr* self, int index, void(*f)(const char32_t*));
	C_ABI_RAW const char32_t* ABI_ListView_getItemCell(ListView::Ptr* self, int rowIndex, int columnIndex);
	C_ABI_RAW void ABI_ListView_getItemRows(ListView::Ptr* self, void(*f)(const char32_t*, int row));
	C_ABI_RAW void ABI_ListView_setItemHeight(ListView::Ptr* self, int itemHeight);
	C_ABI_RAW int ABI_ListView_getItemHeight(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setHeaderTextSize(ListView::Ptr* self, int textSize);
	C_ABI_RAW int ABI_ListView_getHeaderTextSize(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setSeparatorWidth(ListView::Ptr* self, int width);
	C_ABI_RAW int ABI_ListView_getSeparatorWidth(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setHeaderSeparatorHeight(ListView::Ptr* self, int height);
	C_ABI_RAW int ABI_ListView_getHeaderSeparatorHeight(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setGridLinesWidth(ListView::Ptr* self, int width);
	C_ABI_RAW int ABI_ListView_getGridLinesWidth(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setAutoScroll(ListView::Ptr* self, int autoScroll);
	C_ABI_RAW bool ABI_ListView_autoScroll(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setShowVerticalGridLines(ListView::Ptr* self, int showGridLines);
	C_ABI_RAW bool ABI_ListView_showVerticalGridLines(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setShowHorizontalGridLines(ListView::Ptr* self, int showGridLines);
	C_ABI_RAW bool ABI_ListView_showHorizontalGridLines(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setVerticalScrollbarPolicy(ListView::Ptr* self, int policy);
	C_ABI_RAW int ABI_ListView_getVerticalScrollbarPolicy(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setHorizontalScrollbarPolicy(ListView::Ptr* self, int policy);
	C_ABI_RAW int ABI_ListView_getHorizontalScrollbarPolicy(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setVerticalScrollbarValue(ListView::Ptr* self, int value);
	C_ABI_RAW int ABI_ListView_getVerticalScrollbarValue(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setHorizontalScrollbarValue(ListView::Ptr* self, int value);
	C_ABI_RAW int ABI_ListView_getHorizontalScrollbarValue(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setFixedIconSize(ListView::Ptr* self, float width, float height);
	C_ABI_RAW Vector2f* ABI_ListView_getFixedIconSize(ListView::Ptr* self);
	C_ABI_RAW void ABI_ListView_setResizableColumns(ListView::Ptr* self, int resizable);
	C_ABI_RAW bool ABI_ListView_resizableColumns(ListView::Ptr* self);
	C_ABI_RAW SignalInt* ABI_ListView_onItemSelect(ListView::Ptr* self);
	C_ABI_RAW SignalInt* ABI_ListView_onDoubleClick(ListView::Ptr* self);
	C_ABI_RAW SignalInt* ABI_ListView_onRightClick(ListView::Ptr* self);
	C_ABI_RAW SignalInt* ABI_ListView_onHeaderClick(ListView::Ptr* self);
	// ComboBox
	...
	C_ABI_RAW void ABI_FileDialog_setPath(FileDialog::Ptr* self, char* path);
	C_ABI_RAW const char32_t* ABI_FileDialog_getPath(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setFilename(FileDialog::Ptr* self, char* filename);
	C_ABI_RAW const char32_t* ABI_FileDialog_getFilename(FileDialog::Ptr* self);
	...
	C_ABI_RAW int ABI_FileDialog_getFileTypeFiltersIndex(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setConfirmButtonText(FileDialog::Ptr* self, char* text);
	C_ABI_RAW const char32_t* ABI_FileDialog_getConfirmButtonText(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setCancelButtonText(FileDialog::Ptr* self, char* text);
	C_ABI_RAW const char32_t* ABI_FileDialog_getCancelButtonText(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setCreateFolderButtonText(FileDialog::Ptr* self, char* text);
	C_ABI_RAW const char32_t* ABI_FileDialog_getCreateFolderButtonText(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setAllowCreateFolder(FileDialog::Ptr* self, int allowCreateFolder);
	C_ABI_RAW bool ABI_FileDialog_getAllowCreateFolder(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setFilenameLabelText(FileDialog::Ptr* self, char* labelText);
	C_ABI_RAW const char32_t* ABI_FileDialog_getFilenameLabelText(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setListViewColumnCaptions(FileDialog::Ptr* self, char* nameColumnText, char* sizeColumnText, char* modifiedColumnText);
	C_ABI_RAW void ABI_FileDialog_getListViewColumnCaptions(FileDialog::Ptr* self, void(*f)(const char32_t*));
	C_ABI_RAW void ABI_FileDialog_setFileMustExist(FileDialog::Ptr* self, int enforceExistence);
	C_ABI_RAW bool ABI_FileDialog_getFileMustExist(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setSelectingDirectory(FileDialog::Ptr* self, int selectDirectories);
	C_ABI_RAW bool ABI_FileDialog_getSelectingDirectory(FileDialog::Ptr* self);
	C_ABI_RAW void ABI_FileDialog_setMultiSelect(FileDialog::Ptr* self, int multiSelect);
	C_ABI_RAW bool ABI_FileDialog_getMultiSelect(FileDialog::Ptr* self);
	// C_ABI_RAW void ABI_FileDialog_setIconLoader(FileDialog::Ptr* self, std::shared_ptr< FileDialogIconLoader >* iconLoader);
	// C_ABI_RAW std::shared_ptr< FileDialogIconLoader >* ABI_FileDialog_getIconLoader(FileDialog::Ptr* self);
	C_ABI_RAW Signal* ABI_FileDialog_onFileSelect(FileDialog::Ptr* self);
	C_ABI_RAW Signal* ABI_FileDialog_onCancel(FileDialog::Ptr* self);
	// MessageBox
	C_ABI_MAKE MessageBox::Ptr* ABI_MessageBox_new();
	C_ABI_RAW void ABI_MessageBox_setText(MessageBox::Ptr* self, char* text);
	C_ABI_RAW const char32_t* ABI_MessageBox_getText(MessageBox::Ptr* self);
	...
	C_ABI_RAW SignalString* ABI_MessageBox_onButtonPress(MessageBox::Ptr* self);
	// Picture
	C_ABI_MAKE Picture::Ptr* ABI_Picture_new(Texture* texture, int transparent);
	C_ABI_RAW void ABI_Picture_ignoreMouseEvents(Picture::Ptr* self, int ignore);
	C_ABI_RAW bool ABI_Picture_isIgnoringMouseEvents(Picture::Ptr* self);
	C_ABI_RAW SignalVector2f* ABI_Picture_onDoubleClick(Picture::Ptr* self);
	// MenuBar
	C_ABI_MAKE MenuBar::Ptr* ABI_MenuBar_new();
	C_ABI_RAW void ABI_MenuBar_addMenu(MenuBar::Ptr* self, char* text);
	...
	C_ABI_RAW void ABI_MenuBar_removeAllMenus(MenuBar::Ptr* self);
	C_ABI_RAW bool ABI_MenuBar_removeMenu(MenuBar::Ptr* self, char* menu);
	...
	C_ABI_RAW bool ABI_MenuBar_setMenuEnabled(MenuBar::Ptr* self, char* menu, int enabled);
	C_ABI_RAW bool ABI_MenuBar_getMenuEnabled(MenuBar::Ptr* self, char* menu);
	...
	C_ABI_RAW void ABI_MenuBar_setMinimumSubMenuWidth(MenuBar::Ptr* self, float minimumWidth);
	C_ABI_RAW float ABI_MenuBar_getMinimumSubMenuWidth(MenuBar::Ptr* self);
	C_ABI_RAW void ABI_MenuBar_setInvertedMenuDirection(MenuBar::Ptr* self, int invertDirection);
	C_ABI_RAW bool ABI_MenuBar_getInvertedMenuDirection(MenuBar::Ptr* self);
	C_ABI_RAW void ABI_MenuBar_getMenus(MenuBar::Ptr* self, void(*m)(const char32_t*, int), void(*up)());
	C_ABI_RAW void ABI_MenuBar_closeMenu(MenuBar::Ptr* self);
	C_ABI_RAW SignalItemHierarchy* ABI_MenuBar_onMenuItemClick(MenuBar::Ptr* self);
	// PanelListBox
	C_ABI_MAKE PanelListBox::Ptr* ABI_PanelListBox_new();
	C_ABI_RAW Panel::Ptr* ABI_PanelListBox_addItem(PanelListBox::Ptr* self, char* id, int index);
	C_ABI_RAW Panel::Ptr* ABI_PanelListBox_getPanelTemplate(PanelListBox::Ptr* self);
	C_ABI_RAW float ABI_PanelListBox_getItemsWidth(PanelListBox::Ptr* self);
	C_ABI_RAW void ABI_PanelListBox_setItemsHeight(PanelListBox::Ptr* self, char* height);
	C_ABI_RAW float ABI_PanelListBox_getItemsHeight(PanelListBox::Ptr* self);
	C_ABI_RAW bool ABI_PanelListBox_setSelectedItem(PanelListBox::Ptr* self, Panel::Ptr* panel);
	C_ABI_RAW bool ABI_PanelListBox_setSelectedItemById(PanelListBox::Ptr* self, char* id);
	C_ABI_RAW bool ABI_PanelListBox_setSelectedItemByIndex(PanelListBox::Ptr* self, int index);
	C_ABI_RAW void ABI_PanelListBox_deselectItem(PanelListBox::Ptr* self);
	C_ABI_RAW bool ABI_PanelListBox_removeItem(PanelListBox::Ptr* self, Panel::Ptr* panel);
	C_ABI_RAW bool ABI_PanelListBox_removeItemById(PanelListBox::Ptr* self, char* id);
	C_ABI_RAW bool ABI_PanelListBox_removeItemByIndex(PanelListBox::Ptr* self, int index);
	C_ABI_RAW void ABI_PanelLIstBox_removeAllItems(PanelListBox::Ptr* self);
	C_ABI_RAW Panel::Ptr* ABI_PanelListBox_getItemById(PanelListBox::Ptr* self, char* id);
	C_ABI_RAW Panel::Ptr* ABI_PanelListBox_getItemByIndex(PanelListBox::Ptr* self, int index);
	C_ABI_RAW int ABI_PanelListBox_getIndexById(PanelListBox::Ptr* self, char* id);
	C_ABI_RAW int ABI_PanelListBox_getIndexByItem(PanelListBox::Ptr* self, Panel::Ptr* panel);
	C_ABI_RAW const char32_t* ABI_PanelListBox_getIdByIndex(PanelListBox::Ptr* self, int index);
	C_ABI_RAW Panel::Ptr* ABI_PanelListBox_getSelectedItem(PanelListBox::Ptr* self);
	C_ABI_RAW const char32_t* ABI_PanelListBox_getSelectedItemId(PanelListBox::Ptr* self);
	C_ABI_RAW int ABI_PanelListBox_getSelectedItemIndex(PanelListBox::Ptr* self);
	C_ABI_RAW int ABI_PanelListBox_getItemCount(PanelListBox::Ptr* self);
	...
	C_ABI_RAW void ABI_PanelListBox_setMaximumItems(PanelListBox::Ptr* self, int maximumItems);
	C_ABI_RAW int ABI_PanelListBox_getMaximumItems(PanelListBox::Ptr* self);
	C_ABI_RAW bool ABI_PanelListBox_contains(PanelListBox::Ptr* self, Panel::Ptr* panel);
	C_ABI_RAW bool ABI_PanelListBox_containsId(PanelListBox::Ptr* self, char* id);
	C_ABI_RAW SignalPanelListBoxItem* ABI_PanelListBox_onItemSelect(PanelListBox::Ptr* self);
	// ProgressBar
	C_ABI_MAKE ProgressBar::Ptr* ABI_ProgressBar_new();
	C_ABI_RAW void ABI_ProgressBar_setMinimum(ProgressBar::Ptr* self, int minimum);
	C_ABI_RAW int ABI_ProgressBar_getMinimum(ProgressBar::Ptr* self);
	C_ABI_RAW void ABI_ProgressBar_setMaximum(ProgressBar::Ptr* self, int maximum);
	C_ABI_RAW int ABI_ProgressBar_getMaximum(ProgressBar::Ptr* self);
	C_ABI_RAW void ABI_ProgressBar_setValue(ProgressBar::Ptr* self, int value);
	C_ABI_RAW int ABI_ProgressBar_getValue(ProgressBar::Ptr* self);
	C_ABI_RAW int ABI_ProgressBar_incrementValue(ProgressBar::Ptr* self);
	C_ABI_RAW void ABI_ProgressBar_setText(ProgressBar::Ptr* self, char* text);
	C_ABI_RAW const char32_t* ABI_ProgressBar_getText(ProgressBar::Ptr* self);
	...
	C_ABI_RAW SignalUInt* ABI_ProgressBar_onValueChange(ProgressBar::Ptr* self);
	C_ABI_RAW Signal* ABI_ProgressBar_onFull(ProgressBar::Ptr* self);
	// RangeSlider
	C_ABI_MAKE RangeSlider::Ptr* ABI_RangeSlider_new();
	C_ABI_RAW void ABI_RangeSlider_setMinimum(RangeSlider::Ptr* self, float minimum);
	C_ABI_RAW float ABI_RangeSlider_getMinimum(RangeSlider::Ptr* self);
	C_ABI_RAW void ABI_RangeSlider_setMaximum(RangeSlider::Ptr* self, float maximum);
	C_ABI_RAW float ABI_RangeSlider_getMaximum(RangeSlider::Ptr* self);
	C_ABI_RAW void ABI_RangeSlider_setSelectionStart(RangeSlider::Ptr* self, float value);
	C_ABI_RAW float ABI_RangeSlider_getSelectionStart(RangeSlider::Ptr* self);
	C_ABI_RAW void ABI_RangeSlider_setSelectionEnd(RangeSlider::Ptr* self, float value);
	C_ABI_RAW float ABI_RangeSlider_getSelectionEnd(RangeSlider::Ptr* self);
	C_ABI_RAW void ABI_RangeSlider_setStep(RangeSlider::Ptr* self, float step);
	C_ABI_RAW float ABI_RangeSlider_getStep(RangeSlider::Ptr* self);
	C_ABI_RAW SignalRange* ABI_RangeSlider_onRangeChange(RangeSlider::Ptr* self);
	// RichTextLabel
	...
	C_ABI_RAW void ABI_Slider_setMinimum(Slider::Ptr* self, float minimum);
	C_ABI_RAW float ABI_Slider_getMinimum(Slider::Ptr* self);
	C_ABI_RAW void ABI_Slider_setMaximum(Slider::Ptr* self, float maximum);
	C_ABI_RAW float ABI_Slider_getMaximum(Slider::Ptr* self);
	C_ABI_RAW void ABI_Slider_setValue(Slider::Ptr* self, float value);
	C_ABI_RAW float ABI_Slider_getValue(Slider::Ptr* self);
	C_ABI_RAW void ABI_Slider_setStep(Slider::Ptr* self, float step);
	C_ABI_RAW float ABI_Slider_getStep(Slider::Ptr* self);
	C_ABI_RAW void ABI_Slider_setVerticalScroll(Slider::Ptr* self, int vertical);
	C_ABI_RAW bool ABI_Slider_getVerticalScroll(Slider::Ptr* self);
	C_ABI_RAW void ABI_Slider_setInvertedDirection(Slider::Ptr* self, int invertedDirection);
	C_ABI_RAW bool ABI_Slider_getInvertedDirection(Slider::Ptr* self);
	C_ABI_RAW void ABI_Slider_setChangeValueOnScroll(Slider::Ptr* self, int changeValueOnScroll);
	C_ABI_RAW bool ABI_Slider_getChangeValueOnScroll(Slider::Ptr* self);
	C_ABI_RAW SignalFloat* ABI_Slider_onValueChange(Slider::Ptr* self);
	// SpinButton
	...
	C_ABI_RAW void ABI_TreeView_setItemHeight(TreeView::Ptr* self, int itemHeight);
	C_ABI_RAW int ABI_TreeView_getItemHeight(TreeView::Ptr* self);
	C_ABI_RAW void ABI_TreeView_setVerticalScrollbarValue(TreeView::Ptr* self, int value);
	C_ABI_RAW int ABI_TreeView_getVerticalScrollbarValue(TreeView::Ptr* self);
	C_ABI_RAW void ABI_TreeView_setHorizontalScrollbarValue(TreeView::Ptr* self, int value);
	C_ABI_RAW int ABI_TreeView_getHorizontalScrollbarValue(TreeView::Ptr* self);
	C_ABI_RAW SignalItemHierarchy* ABI_TreeView_onItemSelect(TreeView::Ptr* self);
	C_ABI_RAW SignalItemHierarchy* ABI_TreeView_onDoubleClick(TreeView::Ptr* self);
	C_ABI_RAW SignalItemHierarchy* ABI_TreeView_onExpand(TreeView::Ptr* self);
	C_ABI_RAW SignalItemHierarchy* ABI_TreeView_onCollapse(TreeView::Ptr* self);
	C_ABI_RAW SignalItemHierarchy* ABI_TreeView_onRightClick(TreeView::Ptr* self);
	// Scrollbar
	C_ABI_MAKE Scrollbar::Ptr* ABI_Scrollbar_new();
	C_ABI_RAW void ABI_Scrollbar_setMaximum(Scrollbar::Ptr* self, int maximum);
	C_ABI_RAW int ABI_Scrollbar_getMaximum(Scrollbar::Ptr* self);
	C_ABI_RAW void ABI_Scrollbar_setValue(Scrollbar::Ptr* self, int value);
	C_ABI_RAW int ABI_Scrollbar_getValue(Scrollbar::Ptr* self);
	C_ABI_RAW void ABI_Scrollbar_setViewportSize(Scrollbar::Ptr* self, int viewport);
	C_ABI_RAW int ABI_Scrollbar_getViewportSize(Scrollbar::Ptr* self);
	C_ABI_RAW void ABI_Scrollbar_setScrollAmount(Scrollbar::Ptr* self, int scrollAmount);
	C_ABI_RAW int ABI_Scrollbar_getScrollAmount(Scrollbar::Ptr* self);
	C_ABI_RAW void ABI_Scrollbar_setAutoHide(Scrollbar::Ptr* self, int autoHide);
	C_ABI_RAW bool ABI_Scrollbar_getAutoHide(Scrollbar::Ptr* self);
	C_ABI_RAW void ABI_Scrollbar_setVerticalScroll(Scrollbar::Ptr* self, int vertical);
	C_ABI_RAW bool ABI_Scrollbar_getVerticalScroll(Scrollbar::Ptr* self);
	C_ABI_RAW float ABI_Scrollbar_getDefaultWidth(Scrollbar::Ptr* self);
	C_ABI_RAW SignalUInt* ABI_Scrollbar_onValueChange(Scrollbar::Ptr* self);
}
#endif //CABI_HPP